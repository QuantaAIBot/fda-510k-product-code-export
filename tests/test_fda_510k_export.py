...
class ExporterTests(unittest.TestCase):
    ...
    def test_readme_discloses_ai_and_bounds_claims(self):
        ...
        self.assertIn("free product-code activity index", text)
        self.assertIn("/tools/510k-product-code-activity/", text)
        self.assertIn("absent from the prior returned set is not treated as zero", text)
